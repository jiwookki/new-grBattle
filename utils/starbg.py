...
STARS = {
    #CircularStar(1, [160, 160, 160]) : 6,
    CircularStar(1, [225, 225, 225]) : 4,
    CircularStar(2, [195, 195, 195]) : 2,
    #CircularStar(4, [250, 150, 5]) : 1,
}
    ...
    for x in range(0, STARCOUNT):
        ...
        if FORCE_NO_OVERLAP:
            ...
            while looking < 10000:
                ...
                temp_position = [random.randint(0, int(SIZE[0] - chosen_star.size[0])), random.randint(0, int(SIZE[1] - chosen_star.size[1]))]
